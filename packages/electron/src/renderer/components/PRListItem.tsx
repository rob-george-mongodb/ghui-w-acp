...
const stateIcon = (state: PullRequestState) => {
	switch (state) {
		case "open":
			return <span className="state-open">●</span>
		case "closed":
			return <span className="state-closed">●</span>
		case "merged":
			return <span className="state-merged">●</span>
	}
}
...
const checkIcon = (status: CheckRollupStatus) => {
	switch (status) {
		case "passing":
			return <span className="check-passing">✓</span>
		case "pending":
			return <span className="check-pending">◯</span>
		case "failing":
			return <span className="check-failing">✗</span>
		case "none":
			return null
	}
}
...
const reviewIcon = (status: ReviewStatus) => {
	switch (status) {
		case "approved":
			return (
				<span className="check-passing" title="Approved">
					✔
				</span>
			)
		case "changes":
			return (
				<span className="check-failing" title="Changes requested">
					△
				</span>
			)
		case "review":
			return (
				<span className="check-pending" title="Review pending">
					◎
				</span>
			)
		case "draft":
			return (
				<span className="check-none" title="Draft">
					◇
				</span>
			)
		case "none":
